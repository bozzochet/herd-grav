...
INSTALL_PACKAGES="git cmake xercesc geant4 root vgm hepmc crmcg4 ggs eventanalysis"
...
HEPMC_PREFIX=HEPMC_${HEPMC_VERSION}
HEPMC_MOMENTUM=GEV # MEV or GEV
HEPMC_LENGTH=CM # CM or MM

CRMCG4_VERSION=e3539f40
CRMCG4_PREFIX=CRMCG4_${CRMCG4_VERSION}
CRMCG4_REPO_ACCESS_TOKEN=gitlab+deploy-token-4:EiJHexdZY62osiw1Zs4E

GGS_VERSION=2.6.5
GGS_PREFIX=GGS_${GGS_VERSION}
GGS_DISABLE_VGM=0 # Set to 1 to disable VGM in GGS

EVENTANALYSIS_VERSION=c5403642
